...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ReindeerBY/MyFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ReindeerBY' => 'Shavluga' }
  s.source           = { :git => 'https://github.com/ReindeerBY/MyFramework.git', :tag => s.version.to_s }
